...
const CACHE_NAME   = 'spencer-os-v32';
const STATIC_URLS  = [
  '/',
  '/index.html',
  '/manifest.json',
  '/colors_and_type.css?v=32',
  '/db.js?v=32',
  '/ui.jsx?v=32',
  '/Sidebar.jsx?v=32',
  '/TopBar.jsx?v=32',
  '/App.jsx?v=32',
  '/modules/Cash.jsx?v=32',
  '/modules/Investments.jsx?v=32',
  '/modules/HealthPulse.jsx?v=32',
  '/modules/Workouts.jsx?v=32',
  '/modules/DailyChecklist.jsx?v=32',
  '/modules/CRM.jsx?v=32',
  '/modules/Calendar.jsx?v=32',
  '/modules/Journal.jsx?v=32',
  '/modules/Goals.jsx?v=32',
  '/modules/SAT.jsx?v=32',
  '/modules/CommandPalette.jsx?v=32',
