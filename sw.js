...
const CACHE_NAME   = 'spencer-os-v31';
const STATIC_URLS  = [
  '/',
  '/index.html',
  '/manifest.json',
  '/colors_and_type.css?v=31',
  '/db.js?v=31',
  '/ui.jsx?v=31',
  '/Sidebar.jsx?v=31',
  '/TopBar.jsx?v=31',
  '/App.jsx?v=31',
  '/modules/Cash.jsx?v=31',
  '/modules/Investments.jsx?v=31',
  '/modules/HealthPulse.jsx?v=31',
  '/modules/Workouts.jsx?v=31',
  '/modules/DailyChecklist.jsx?v=31',
  '/modules/CRM.jsx?v=31',
  '/modules/Calendar.jsx?v=31',
  '/modules/Journal.jsx?v=31',
  '/modules/Goals.jsx?v=31',
  '/modules/SAT.jsx?v=31',
  '/modules/CommandPalette.jsx?v=31',
